...
- The release-status workflow reads public GitHub release metadata and writes only public stage, version and timestamp information to `release-status.json`.
