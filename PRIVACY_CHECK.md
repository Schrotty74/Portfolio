...
- The release-status workflow reads public GitHub release metadata and writes only public stage, version, timestamp and available DMG/ZIP download URLs to `release-status.json`.
