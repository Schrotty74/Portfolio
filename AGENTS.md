...
- Bei jeder Änderung an browserseitig gecachten HTML-, CSS- oder JavaScript-Ressourcen die verwendete Cache-Busting-Version in den betroffenen Referenzen erhöhen. Gemeinsame Ressourcen in englischen und deutschen Seiten konsistent versionieren. Die Versionskennung ist nur ein Query-Parameter an derselben Datei; dafür keine zusätzlichen Versionskopien der Datei im Repository anlegen.
